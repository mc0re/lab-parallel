namespace CancelFlow
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolStripProgressBar1.ToolTipText = "Stage 1 count";
			// 
			// toolStripProgressBar2
			// 
			this.toolStripProgressBar2.Name = "toolStripProgressBar2";
			this.toolStripProgressBar2.Size = new System.Drawing.Size(100, 22);
			this.toolStripProgressBar2.ToolTipText = "Stage 2 count";
			// 
			...
			this.toolStripProgressBar3.ToolTipText = "Completed";
			// 
			...
			this.toolStripProgressBar4.ToolTipText = "Cancelled";
			// 
			// Form1
			// 
			...
			this.Name = "Form1";
			this.Text = "Cancellable data flow";
